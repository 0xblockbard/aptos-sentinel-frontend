    ...
    <div class="flex max-w-7xl w-full px-10 pt-10 sm:pt-24 pb-12 sm:pb-0 mx-auto">
        ...
        <div class="campaign_container single_campaign flex flex-col sm:flex-row w-full">
            ...
            <div class="flex flex-col w-full sm:w-1/3 sm:px-6 py-2 ">
                ...
                <h2 id="name" class="inline name text-2xl font-semibold mt-2">Loading Campaign...</h2>
                
                <div class="relative mt-3 pt-1">
                    <div class="flex mb-2 items-center justify-between">
                        <div>
                            <div class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-sky-600 bg-sky-200">
                        ...
                        <div class="text-right">
                            <span id="contributed_amount" class="contributed_amount text-xs font-semibold inline-block text-sky-600">
                                X
                            </span>
                            <span class="text-xs font-semibold inline-block text-sky-600">
                                /
                            </span>
                            <span id="target_amount" class="target_amount text-xs font-semibold inline-block text-sky-600">
                                XXX
                            </span>
                            <span class="text-xs font-semibold inline-block text-sky-600">
                                APT
                    ...
                    <div class="overflow-hidden h-2 mb-2 text-xs flex rounded bg-sky-200">
                        <div id="progress_bar" style="width:30%" class="progress_bar shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-sky-500"></div>
                    </div>
                    <div class="flex justify-between mb-3 pl-1 pr-1">
{{-- 
                        <div class="flex text-sm">
                            <span class="backers font-extrabold pr-2 text-sky-600">XX</span>
                            <span>supporters</span>
                        </div> --}}

                        <div class="flex text-sm days_remaining_container">
                            <span id="days_remaining" class="days_remaining font-extrabold pr-1 text-sky-600">30</span>
                ...
                <div id="contribute_form" class="contribute_form mt-3">
                    <label for="contribution" class="block text-sm text-sky-700 font-bold">Support This Campaign:</label>
                    <div class="mt-3 flex rounded-md shadow-sm">
                        <div class="relative flex items-stretch flex-grow focus-within:z-10">
                            <input type="text" name="contribution" id="contribution" class="contribution border focus:ring-sky-500 focus:border-sky-500 block w-full rounded-none rounded-l-md pl-4 sm:text-sm border-gray-300" placeholder="Pledge Amount" />
                        </div>
                        <button type="button" class="-ml-px relative inline-flex items-center space-x-2 px-4 py-2 border border-gray-300 text-sm font-medium rounded-r-md text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500">
                            <span>APT</span>
                        </button>
                    </div>
