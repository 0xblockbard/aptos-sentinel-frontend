<footer class="bg-white border-t-2 border-sky-600 z-20 ">
        ...
        <div class="flex flex-row justify-between">
            ...
            <div class="flex flex-col">
                ...
                <a href="{{ route('home') }}" class="pl-1">
                    <span class="font-sans text-lg font-extrabold text-sky-600">PropVerify</span>
                </a>
                <p class="hidden sm:block text-gray-600 font-title text-sm pl-1 font-semibold">
                    Modular KYC-RWA Framework
                </p>
                ...
                <div class="flex flex-col w-24 sm:w-32 pl-2">
                    <div class="mt-0">
                        ...
                        <ul class="mt-1 sm:mt-4 space-y-4 text-md">
                            ...
                            <li>
                                <a href="{{ route('show_all_campaigns') }}" class="text-gray-500 hover:text-gray-900 ">
                                    Campaigns
                                </a>
                            </li>
